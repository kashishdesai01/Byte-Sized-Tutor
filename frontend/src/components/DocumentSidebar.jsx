...
import { TrashIcon } from './icons.jsx'; // Assuming icons.jsx exists
...
function DocumentSidebar({ 
    ...
    return (
        // ✅ UPDATED: Sidebar with a clean, light theme and border
        <aside className="w-1/3 max-w-sm bg-white pt-8 p-4 flex flex-col h-full border-r border-slate-200">
            ...
            {/* ✅ UPDATED: Redesigned upload section */}
            ...
            <div className="flex-grow overflow-y-auto space-y-1 pr-2">
                {documents.map(doc => (
                    <div 
                        ...
                        // ✅ UPDATED: Redesigned list item with better hover/active states
            ...
            {/* ✅ UPDATED: Secondary-style logout button */}
